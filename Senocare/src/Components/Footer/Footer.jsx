  ...
  return (
    <>
        ...
        <Row>
          <Col lg={5} xs={12} md={6}>
            ...
            <div className="grid_footer">
              <div className="header_text address address__bar">
                ...
                >
                  <p>
                    Senocare Services Pvt. Ltd. 802, 08th floor, JMD Regent
                    square, MG Road, Gurgaon Haryana 122002
                  </p>
                </a>
                <p>For any feedback or concerns, call us on</p>
                {/* <p>Email: conferences@miceandmore.co.in</p> */}
          ...
          <Col lg={2} xs={12} md={6}>
            ...
            <div className="grid_footer">
              <div className="header_text address">
                ...
                <Link to="/package">
                  <HashLink to="/package/#package">
                    <p className="link">Care Package</p>
                  </HashLink>
                </Link>
                <Link to="https://blog.senocare.in/">
          ...
          <Col lg={2} xs={12} md={6}>
            ...
            <div className="grid_footer">
              <div className="header_text address">
                <Link to="/volunteer">
                  <HashLink to="/volunteer/#volunteer">
                    <p className="link">Voluntree With Us</p>
                  </HashLink>
                </Link>

                <Link to="/privacy-policy">
                  <HashLink to="/privacy-policy/#privacy">
                    <p className="link">Privacy Policy</p>
                  </HashLink>
                </Link>
                <Link to="/term-and-conditions">
                  <HashLink to="/term-and-conditions/#term_Conditions">
                    <p className="link">Term & Conditions</p>
                  </HashLink>
                </Link>
                <Link to="/disclaimer">
                  <HashLink to="/disclaimer/#disclaimer">
      ...
      <div className="footer_copyright">
        <p>&copy; 2026. Senocare Services Pvt. Ltd. All Rights Reserved.</p>
      </div>
    </>
  );
};
